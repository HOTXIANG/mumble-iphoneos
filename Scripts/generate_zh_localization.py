...
MANUAL_TRANSLATIONS = {
    ...
    "Adaptive Bitrate:": "自适应码率：",
    "Capture All Input Channels": "采集所有输入声道",
    "Enhanced PLC": "增强丢包补偿",
    "Enhanced PLC:": "增强丢包补偿：",
    "Someone": "某人",
    "Status:": "状态：",
    ...
    "Choose the hardware channel to use as the mono input source for this microphone.": "选择要作为此麦克风单声道输入源的硬件声道。",
    "Choose which hardware channels feed the left and right sides of the stereo input.": "选择哪些硬件声道分别输入到立体声的左、右声道。",
    ...
    "Enable this only for multi-channel USB microphones that otherwise show no input. It may affect macOS voice modes and expose Wide Spectrum.": "仅在多声道 USB 麦克风原本没有输入时启用。它可能影响 macOS 的语音模式，并显示“宽频”选项。",
    ...
    "Enable QoS": "启用 QoS",
    "Export Track Preset": "导出轨道预设",
    "Failed to create audio format": "创建音频格式失败",
    "Exported track preset for %@": "已为 %@ 导出轨道预设",
    "Failed to export track preset: %@": "导出轨道预设失败：%@",
    "Failed to import track preset: %@": "导入轨道预设失败：%@",
    "Failed to read track preset: %@": "读取轨道预设失败：%@",
    "IP Address (e.g. 192.168.1.1)": "IP 地址（例如 192.168.1.1）",
    "Import Track Preset": "导入轨道预设",
    "Imported track preset '%@'": "已导入轨道预设“%@”",
    ...
    "Removed empty plugin slot": "已移除空插件插槽",
    "Remove Avatar": "移除头像",
    "Remove Friend": "移除好友",
    ...
    "Sidetone Track": "返听轨道",
    "Social": "社交",
    "Switched to external mic. Re-select Voice Isolation mode, then restart app for it to take effect.": "已切换到外接麦克风。请重新选择语音隔离模式，然后重启应用以使其生效。",
    ...
    "Added empty plugin slot": "已添加空插件插槽",
